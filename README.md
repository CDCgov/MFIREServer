...
* VR-MRT build/executable: Extract the MFIREServer-MFIRE4-2026-04-06.zip folder into the same folder as your VR-MRT build or executable folder within Windows Explorer

## How to Use MFIRE Server
* Before running VR-MRT, run "MFireServer.exe"
* If the MFIREServer window does not pop-up by default, ensure the MFIRE Server is running by either mousing over the taskbar icons on the bottom-right corner of the Windows taskbar and verifying that the MFIRE Server icon is present and running
